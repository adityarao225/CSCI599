...
function initScene(containerId, objPath) {
...
initScene('container1', '../assets/assignment1/cube_subdivided.obj');

// Initialize the second scene
initScene('container2', '../assets/assignment1/cube_decimated.obj');
